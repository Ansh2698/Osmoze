...
<section id="home-section" class="hero js-fullheight">
            ...
            <div class="container-fluid px-0">
                ...
                <div class="one-forth js-fullheight d-flex align-items-start align-items-md-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
                    <div class="text mt-4 mt-md-0">
                        <h1 class="mb-4">Annual Chemical<span> Extravaganza</span> 2020</span></h1>
                        <h2 class="mb-4">April 9-12, 2020</h2>
                        <p><a href="#about-section" class="btn btn-primary py-3 px-4">Read More</a></p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid px-0">
        <div class="row d-flex no-gutters slider-text js-fullheight align-items-end justify-content-end" data-scrollax-parent="true">
            <div class="one-third order-md-last js-fullheight img-base" style="background-image:url(images/osmoze-bg_2.JPG);">
                <div class="overlay"></div>
            </div>
            <div class="one-forth js-fullheight d-flex align-items-start align-items-md-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
                <div class="text mt-4 mt-md-0">
                <h1 class="mb-4">Annual Chemical<span> Extravaganza</span> 2020</h1>
                <h2 class="mb-4">April 9-12, 2020</h2>
                <p><a href="#about-section" class="btn btn-primary py-3 px-4">Read More</a></p>
            </div>
            </div>
    ...
    <div class="slider-item js-fullheight">
            ...
            <div class="container-fluid px-0">
                <div class="row d-md-flex no-gutters slider-text js-fullheight align-items-end justify-content-end" data-scrollax-parent="true">
                    <div class="one-third order-md-last js-fullheight img-base" style="background-image:url(images/osmoze-bg_3.JPG);">
                        <div class="overlay"></div>
                    </div>
                <div class="one-forth js-fullheight d-flex align-items-start align-items-md-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
                    <div class="text mt-4 mt-md-0">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="event-name">
                        <p style="font-size:32px;font-weight:bold;color:white">Osmoze'20 Coming In</p>
            ...
            <div class="row">
                <div class="col-md-3 col-sm-6 col-xs-6 fw-600">
                    <div class="speaker-col wow fadeInLeft animated" data-wow-duration=".5s" data-wow-delay="0s">
                        <div class="speaker-box">
                            <div class="pic">
                                <img src="images/team/osmoze-team_1.jpeg" alt="">
                                <ul class="social">
                ...
                <div class="col-md-3 col-sm-6 col-xs-6 fw-600">
                    <div class="speaker-col wow fadeInLeft animated" data-wow-duration=".5s" data-wow-delay=".2s">
                        <div class="speaker-box">
                            <div class="pic">
                                <img src="images/team/osmoze-team_2.jpeg" alt="">
                                <ul class="social">
                                    <li><a href="https://www.facebook.com/anmolg.gupta" target="_blank"><i class="fa fa-facebook"></i></a></li>
                                    <li><a href="https://www.instagram.com/greymatter5457/?hl=hu" target="_blank"><i class="fa fa-instagram"></i></a></li>
                                    <li><a href="https://www.linkedin.com/in/anmol-gupta-9520a914a" target="_blank"><i class="fa fa-linkedin"></i></a></li>
                ...
                <div class="col-md-3 col-sm-6 col-xs-6 fw-600">
                    <div class="speaker-col wow fadeInLeft animated" data-wow-duration=".5s" data-wow-delay=".3s">
                        <div class="speaker-box">
                            <div class="pic">
                                <img src="images/team/osmoze-team_3.jpg" alt="">
                                <ul class="social">
                                    <li><a href="https://www.facebook.com/anmolg.gupta" target="_blank"><i class="fa fa-facebook"></i></a></li>
                                    <li><a href="https://www.instagram.com/greymatter5457/?hl=hu" target="_blank"><i class="fa fa-instagram"></i></a></li>
                                    <li><a href="https://www.linkedin.com/in/anmol-gupta-9520a914a" target="_blank"><i class="fa fa-linkedin"></i></a></li>
                        ...
                        <div class="speaker-info">
                            ...
                            <span>Marketing Head, SoChem</span>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6 col-xs-6 fw-600">
                    <div class="speaker-col wow fadeInLeft animated" data-wow-duration=".5s" data-wow-delay=".3s">
                        <div class="speaker-box">
                            <div class="pic">
                                <img src="images/team/osmoze-team_4.jpeg" alt="">
                                <ul class="social">
                                    <li><a href="https://www.facebook.com/anmolg.gupta" target="_blank"><i class="fa fa-facebook"></i></a></li>
                                    <li><a href="https://www.instagram.com/greymatter5457/?hl=hu" target="_blank"><i class="fa fa-instagram"></i></a></li>
                                    <li><a href="https://www.linkedin.com/in/anmol-gupta-9520a914a" target="_blank"><i class="fa fa-linkedin"></i></a></li>
                        ...
                        <div class="speaker-info">
                            <h4>Aayush Khandelwal</h4>
                            <span>Senior Member, SoChem</span>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6 col-xs-6 fw-600">
                    <div class="speaker-col wow fadeInLeft animated" data-wow-duration=".5s" data-wow-delay=".3s">
                        <div class="speaker-box">
                            <div class="pic">
                                <img src="images/team/osmoze-team_5.jpg" alt="">
                                <ul class="social">
                                    <li><a href="https://www.facebook.com/anmolg.gupta" target="_blank"><i class="fa fa-facebook"></i></a></li>
                                    <li><a href="https://www.instagram.com/greymatter5457/?hl=hu" target="_blank"><i class="fa fa-instagram"></i></a></li>
                                    <li><a href="https://www.linkedin.com/in/anmol-gupta-9520a914a" target="_blank"><i class="fa fa-linkedin"></i></a></li>
                ...
                <div class="col-md-3 col-sm-6 col-xs-6 fw-600">
                    <div class="speaker-col wow fadeInLeft animated" data-wow-duration=".5s" data-wow-delay=".3s">
                        <div class="speaker-box">
                            <div class="pic">
                                <img src="images/team/osmoze-team_6.jpg" alt="">
                                <ul class="social">
                                    <li><a href="https://www.facebook.com/anmolg.gupta" target="_blank"><i class="fa fa-facebook"></i></a></li>
                                    <li><a href="https://www.instagram.com/greymatter5457/?hl=hu" target="_blank"><i class="fa fa-instagram"></i></a></li>
                                    <li><a href="https://www.linkedin.com/in/anmol-gupta-9520a914a" target="_blank"><i class="fa fa-linkedin"></i></a></li>
